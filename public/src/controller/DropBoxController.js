class DropBoxController {
    ...
    constructor(){
        ...
        this.progressBarEl = this.snackModalEl.querySelector('.mc-progress-bar-bg >.mc-progress-bar-fg');
        this.namefilenameEl =  this.snackModalEl.querySelector('.filename');
    ...
    connectFirebase(){
        var firebaseConfig = {
            apiKey: "AIzaSyBsbLcniwEt60kS5_Sc2SR_UjhYz9X9NyI",
            authDomain: "dropbox-clone-444a1.firebaseapp.com",
            databaseURL: "https://dropbox-clone-444a1.firebaseio.com",
            projectId: "dropbox-clone-444a1",
            storageBucket: "dropbox-clone-444a1.appspot.com",
            messagingSenderId: "315191658583",
            appId: "1:315191658583:web:36c792b63cc1dfc2c9fb12",
            measurementId: "G-73XK8NTMHP"
        };
    ...
    initEvents(){
        ...
        this.btnRename.addEventListener('click',e=>{
            ...
            let name = prompt('Renomer arquivo',file.name);
        ...
        this.listFilesEl.addEventListener('onSelectionChange',e=>{
        ...
        this.inputFilesEl.addEventListener('change',event => {
            ...
            this.btnSendFileEl.disbled = true;
    ...
    uploadComplete(){
        ...
        this.btnSendFileEl.disbled = false;
    }
    ...
    modalToogleShow(){
        this.snackModalEl.style.display=this.snackModalEl.style.display=='block'?'none':'block';
    }
    ...
    uploadProgress(event, file){
        ...
        this.namefilenameEl.innerHTML = file.name;
    ...
    renderNav(){
        ...
        for (let i = 0; i < this.currentFolder.length; i++)
        {
            ...
            if((1 + i) === this.currentFolder.length)
            {
    ...
    initEventsLi(li){
        ...
        li.addEventListener('click',el=>{
            ...
            if(el.shiftKey)
            {
                let first = this.listFilesEl.querySelector('.selected');
